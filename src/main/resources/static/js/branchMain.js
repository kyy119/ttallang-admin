        ...
        data.forEach(function (branch) {
          ...
          data.forEach(function (branch) {
            if (filterStatus === null || branch.branchStatus === filterStatus) {
              ...
              tableBody.append("<tr><td><a href='/admin/branch/map?branchId="
                  + branch.branchId + "'>" + branch.branchName + statusText
                  + "</a></td><td>" + branch.bicycleCount
                  + "</td><td><a href='/admin/branch/edit?branchId="
                  + branch.branchId + "'>수정하기</a></td></tr>");
            }
          });
